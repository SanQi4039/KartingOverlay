_APP_TEXTS: dict[str, str] = {
    ...
    "browse_background": "选择背景图",
    "browse_video": "选择视频文件",
    "save_project": "保存项目",
    "load_project": "加载项目",
    "select_telemetry_file": "选择遥测文件",
    "select_background_file": "选择背景图",
    ...
    "background_file_filter": "图片文件 (*.png *.jpg *.jpeg *.bmp *.webp);;所有文件 (*)",
    ...
    "fps": "帧率",
    "overlay_resolution": "Overlay 分辨率",
    "output_path": "输出路径",
